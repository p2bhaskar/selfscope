...
//   /* ── Main ── */
//   .main { flex: 1; min-width: 0; display: flex; flex-direction: column; overflow: hidden; background: var(--bg); }
//   .topbar { padding: 20px 36px; border-bottom: 1px solid var(--border); display: flex; align-items: center; justify-content: space-between; background: var(--surface); flex-shrink: 0; }
//   .page-title { font-family: 'Playfair Display', serif; font-size: 26px; font-weight: 700; color: var(--text); }
//   .page-subtitle { font-family: 'DM Mono', monospace; font-size: 11px; color: var(--muted); margin-top: 2px; letter-spacing: 0.5px; }
//   .topbar-actions { display: flex; gap: 10px; align-items: center; }
//   .btn { padding: 9px 18px; border-radius: 6px; font-size: 13px; font-weight: 700; cursor: pointer; transition: all 0.2s; letter-spacing: 0.3px; font-family: 'Lato', sans-serif; border: none; }
//   .btn-primary { background: var(--gold); color: #0a0c12; }
//   .btn-primary:hover { background: var(--gold-light); transform: translateY(-1px); }
//   .btn-ghost { background: transparent; border: 1px solid var(--border); color: var(--muted); }
//   .btn-ghost:hover { border-color: var(--gold); color: var(--gold); }
//   .btn-danger { background: transparent; border: 1px solid var(--rose); color: var(--rose); }
...
//   .tab { padding: 10px 20px; font-size: 13px; font-weight: 700; cursor: pointer; color: var(--muted); border-bottom: 2px solid transparent; transition: all 0.2s; letter-spacing: 0.3px; white-space: nowrap; }
//   .tab.active { color: var(--gold); border-bottom-color: var(--gold); }
//   .tab:hover:not(.active) { color: var(--text); }
...
//      Sidebar hides. Bottom nav appears.
//   ════════════════════════════════════════════ */
...
//     /* Main takes full width, leaves room for bottom nav */
//     .main { width: 100%; padding-bottom: var(--nav-h); }
...
//     .toast { bottom: calc(var(--nav-h) + 12px); right: 12px; left: 12px; text-align: center; }
...
//     .journal-compose { padding: 16px; }

//     /* Modals full-width on mobile */
//     .modal { width: 96vw; padding: 20px; border-radius: 16px; }
...
//     .bottom-nav-item { padding: 10px 8px; }
//   }
// `;