...
//Android app specific styles fixes
...
export const style = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 768px) {
    ...
    /* ── Base ── */
    .app { flex-direction: column; background: #08090f; }

    /* ── Hide desktop sidebar ── */
    .sidebar { display: none; }

    /* ── Main layout ── */
    .main { width: 100vw; padding-bottom: 80px; background: #08090f; }
    ...
    .page-title {
      font-size: 24px;
      font-weight: 900;
      background: linear-gradient(135deg, #f0cc6e, #c9a84c);
    ...
    .stat-card {
      padding: 16px 14px;
      border-radius: 16px;
      background: linear-gradient(135deg, #111520, #0e1219);
      border: 1px solid rgba(255,255,255,0.07);
    }
    .stat-card::before { height: 2px; border-radius: 16px 16px 0 0; }
    .stat-label { font-size: 9px; letter-spacing: 1.5px; margin-bottom: 8px; }
    ...
    .goals-full { grid-template-columns: 1fr; gap: 12px; }
    ...
    /* ── Entry items ── */
    .entry-item { padding: 14px; border-radius: 12px; }
    .entry-title { font-size: 14px; }
    .entry-text { font-size: 13px; }

    /* ── Expense items ── */
    .expense-item { padding: 12px 14px; border-radius: 12px; }
    .expense-name { font-size: 14px; }
    .expense-amount { font-size: 15px; }

    /* ── Goal cards ── */
    .goal-card { padding: 18px; border-radius: 16px; }
    .goal-card-title { font-size: 16px; }

    /* ── Buttons ── */
    .btn { padding: 10px 18px; font-size: 13px; border-radius: 10px; }
    .btn-primary { border-radius: 12px; }

    /* ── Inputs ── */
    .input-field { padding: 12px 14px; font-size: 14px; border-radius: 10px; }
    textarea.input-field { min-height: 100px; }

    /* ── Journal compose ── */
    .journal-input-row { flex-direction: column; gap: 10px; }
    .journal-compose { border-radius: 16px; padding: 18px; }

    /* ── Tabs ── */
    .tabs { overflow-x: auto; gap: 4px; padding-bottom: 2px; }
    .tab { white-space: nowrap; padding: 10px 16px; font-size: 12px; border-radius: 8px 8px 0 0; }
    ...
    /* ── Wake tracker ── */
    .wake-tracker { grid-template-columns: repeat(7, 1fr); gap: 4px; }
    .wake-dot { width: 34px; height: 34px; font-size: 11px; }

    /* ── Charts ── */
    .mini-chart { height: 70px; gap: 4px; }
    .big-chart { height: 120px; gap: 8px; }

    /* ── Milestones ── */
    .milestone-item { font-size: 13px; padding: 8px 0; }
  ...
  @media (max-width: 360px) {
    .stats-grid { grid-template-columns: 1fr; }
    .bottom-nav-item { padding: 8px 10px; min-width: 48px; }
